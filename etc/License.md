...
Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using Password Generator.
...
- __Application__ means the software program provided by the Company downloaded by You to a Device, named Password Generator


- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Password Generator.
...
- You shall not modify, reverse engineer, decompile, disassemble, or create derivative works based on the Software.
- You shall not distribute, sublicense, lease, rent, or lend the Software to any third party.
- You shall not remove or alter any copyright notices, trademarks, or other proprietary markings present on or within the Software.
...
- By email: coderzzzrashhh@gmail.com